 ...
 */
package com.arcussmarthome.core.dao.decorators;
...
public class PersonSource implements PersonDAO {
    ...
    * @param password
    * @return
    * @see com.arcussmarthome.core.dao.PersonDAO#create(com.arcussmarthome.messages.model.Person, java.lang.String)
    */
    ...
    * @param person
    * @return
    * @see com.arcussmarthome.core.dao.PersonDAO#createPersonWithNoLogin(com.arcussmarthome.messages.model.Person)
    */
    ...
    * @param person
    * @return
    * @see com.arcussmarthome.core.dao.PersonDAO#update(com.arcussmarthome.messages.model.Person)
    */
