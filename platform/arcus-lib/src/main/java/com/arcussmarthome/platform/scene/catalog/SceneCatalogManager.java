...
import com.arcussmarthome.platform.scene.catalog.serializer.SceneType;
...
public class SceneCatalogManager {
   ...
   private Map<String, SceneCatalog> loadCatalog() {
      ...
      com.arcussmarthome.platform.scene.catalog.serializer.SceneCatalog sc = JAXBUtil.fromXml(resource, com.arcussmarthome.platform.scene.catalog.serializer.SceneCatalog.class);
   ...
   private static List<ActionResolver> createResolvers(CapabilityRegistry registry, com.arcussmarthome.platform.scene.catalog.serializer.SceneCatalog sc) {
