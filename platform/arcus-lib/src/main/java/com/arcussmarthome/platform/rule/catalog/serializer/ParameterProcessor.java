...
import com.arcussmarthome.platform.rule.catalog.action.Parameter;
import com.arcussmarthome.platform.rule.catalog.action.ParameterValueAttribute;
import com.arcussmarthome.platform.rule.catalog.action.ParameterValueConstant;
import com.arcussmarthome.platform.rule.catalog.action.ParameterValueTime;
import com.arcussmarthome.platform.rule.catalog.action.config.ParameterConfig;
import com.arcussmarthome.platform.rule.catalog.action.config.ParameterConfig.ParameterType;
