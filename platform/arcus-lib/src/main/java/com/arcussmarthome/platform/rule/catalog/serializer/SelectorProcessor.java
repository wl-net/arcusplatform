...
import com.arcussmarthome.capability.definition.AttributeDefinition;
...
import com.arcussmarthome.platform.rule.catalog.selector.ConstantListSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.ConstantSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.FilteringListSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.ListSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.MinMaxSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.MinMaxSelectorGenerator.Unit;
import com.arcussmarthome.platform.rule.catalog.selector.Option;
import com.arcussmarthome.platform.rule.catalog.selector.PresenceSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.SelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.SelectorType;
import com.arcussmarthome.platform.rule.catalog.selector.TemperatureSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.selector.TextSelectorGenerator;
import com.arcussmarthome.platform.rule.catalog.template.TemplatedValue;
import com.arcussmarthome.serializer.sax.TagProcessor;
