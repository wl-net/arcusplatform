...
import com.arcussmarthome.platform.model.ObjectDispatcherModule;
import com.arcussmarthome.platform.pairing.handler.AddCustomizationRequestHandler;
import com.arcussmarthome.platform.pairing.handler.CustomizeRequestHandler;
import com.arcussmarthome.platform.pairing.handler.DismissRequestHandler;
import com.arcussmarthome.platform.pairing.handler.RemoveRequestHandler;
import com.arcussmarthome.platform.pairing.handler.UpdatePairingPhaseRequestHandler;
import com.arcussmarthome.platform.pairing.resolver.PairingDeviceResolver;
