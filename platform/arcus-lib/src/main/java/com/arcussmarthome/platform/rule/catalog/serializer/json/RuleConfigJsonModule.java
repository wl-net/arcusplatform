...
import com.arcussmarthome.platform.rule.catalog.condition.config.IfConditionConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.OrConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.QueryChangeConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.ReceivedMessageConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.ReferenceFilterConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.ThresholdConfig;
import com.arcussmarthome.platform.rule.catalog.condition.config.TimeOfDayConfig;
