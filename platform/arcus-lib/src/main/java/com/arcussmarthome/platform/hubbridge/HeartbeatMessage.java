 ...
 */
package com.arcussmarthome.platform.hubbridge;
...
public class HeartbeatMessage {
   ...
   public static class Builder {
      ...
      public com.arcussmarthome.messages.MessageBody build() {
         return com.arcussmarthome.messages.MessageBody.buildMessage(NAME, ImmutableMap.of(ATTR_CONNECTED_HUB_IDS, connectedHubIds));
      }
   }
}
