...
public class PairingCatalogManager {
	...
	protected PairingCatalog parse(InputStream is) {
		try {
			com.arcussmarthome.prodcat.pairing.serializer.PairingCatalog deserialized = JAXBUtil.fromXml(is, com.arcussmarthome.prodcat.pairing.serializer.PairingCatalog.class);
