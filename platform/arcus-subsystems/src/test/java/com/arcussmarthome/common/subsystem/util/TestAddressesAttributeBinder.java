...
public class TestAddressesAttributeBinder extends SubsystemTestCase<SubsystemModel> {
   ...
   public void testAddFiltered() {
      AddressesAttributeBinder binder = new AddressesAttributeBinder(com.arcussmarthome.model.predicate.Predicates.isA(SwitchCapability.NAMESPACE), attributeName);
