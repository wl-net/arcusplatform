 ...
 */
package com.arcussmarthome.common.subsystem.alarm.security;

import static com.arcussmarthome.model.predicate.Predicates.attributeEquals;
import static com.arcussmarthome.model.predicate.Predicates.attributeNotEquals;
import static com.arcussmarthome.model.predicate.Predicates.isA;
...
import com.arcussmarthome.common.subsystem.alarm.AlarmUtil.CheckSecurityModeOption;
...
import com.arcussmarthome.messages.model.dev.ContactModel;
import com.arcussmarthome.messages.model.dev.GlassModel;
import com.arcussmarthome.messages.model.dev.MotionModel;
import com.arcussmarthome.messages.model.dev.MotorizedDoorModel;
...
public class SecurityAlarm extends AlarmStateMachine<AlarmSubsystemModel> {
	...
	private static final Predicate<Model> ready = Predicates.and(
			Predicates.not(com.arcussmarthome.model.predicate.Predicates.isDeviceOffline()),
		...
		if(SecuritySubsystemModel.isAlarmStateARMED(securitySubsystem)) {
			...
			AlarmModel.setExcludedDevices(
					...
					ImmutableSet.copyOf(
							Sets.intersection(
									allDevices,
									SubsystemUtils.getAddresses(context, Predicates.or(triggered, com.arcussmarthome.model.predicate.Predicates.isDeviceOffline()))
							)
					)
			);
		}
