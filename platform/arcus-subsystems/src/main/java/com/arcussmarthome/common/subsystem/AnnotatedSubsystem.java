 ...
 * 
 */
package com.arcussmarthome.common.subsystem;
...
import com.arcussmarthome.common.subsystem.event.SubsystemActivatedEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemAddedEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemDeactivatedEvent;
...
import com.arcussmarthome.common.subsystem.event.SubsystemStartedEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemStoppedEvent;
...
public class AnnotatedSubsystem<M extends SubsystemModel> implements Subsystem<M> {
   ...
   @SuppressWarnings("unchecked")
	private static <M extends SubsystemModel> Class<M> typeOf(Class<?> type) {
      com.arcussmarthome.common.subsystem.annotation.Subsystem annotation = type.getAnnotation(com.arcussmarthome.common.subsystem.annotation.Subsystem.class);
      if(annotation == null) {
