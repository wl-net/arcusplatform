 ...
 */
package com.arcussmarthome.common.subsystem.presence;
...
import com.arcussmarthome.common.subsystem.util.MapVariableBinder;
...
public class PresenceSubsystem extends BaseSubsystem<PresenceSubsystemModel> {
   ...
   protected void onUpgraded(
         ...
         com.arcussmarthome.model.Version oldVersion
   ) {
