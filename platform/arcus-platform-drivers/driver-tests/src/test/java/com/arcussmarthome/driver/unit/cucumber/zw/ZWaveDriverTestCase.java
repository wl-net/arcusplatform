 ...
 */
package com.arcussmarthome.driver.unit.cucumber.zw;

import com.arcussmarthome.driver.groovy.GroovyProtocolPluginModule;
import com.arcussmarthome.driver.unit.cucumber.AbstractDriverTestCase;
import com.arcussmarthome.driver.unit.cucumber.CommandBuilder;
import com.arcussmarthome.driver.unit.cucumber.DataTypeUtilities;
import com.arcussmarthome.driver.unit.cucumber.DriverTestContext;
import com.arcussmarthome.protocol.ProtocolMessage;
import com.arcussmarthome.protocol.zwave.Protocol.Command;
import com.arcussmarthome.protocol.zwave.Protocol.Message;
...
import com.arcussmarthome.protocol.zwave.model.ZWaveCommand;
import com.arcussmarthome.protocol.zwave.model.ZWaveCommandClass;
...
public class ZWaveDriverTestCase extends AbstractDriverTestCase implements DriverTestContext<ZWaveMessage> {
    ...
    @Override
    public com.arcussmarthome.protocol.Protocol<ZWaveMessage> getProtocol() {
    ...
    public void checkTimeoutSeconds(ProtocolMessage message, Integer expectedTimeoutSeconds )throws IOException{
    	com.arcussmarthome.protocol.zwave.Protocol.Message protocol = (com.arcussmarthome.protocol.zwave.Protocol.Message)message.getValue();
 		assert protocol.getType() == com.arcussmarthome.protocol.zwave.Protocol.SetOfflineTimeout.ID: "Not a timeout message";
 		com.arcussmarthome.protocol.zwave.Protocol.SetOfflineTimeout ptout = com.arcussmarthome.protocol.zwave.Protocol.SetOfflineTimeout.serde().nettySerDe().decode( Unpooled.wrappedBuffer(protocol.getPayload()) );
    ...
    public void checkPoll(ProtocolMessage message, String cmdClass, String command, int period)throws IOException{
    	com.arcussmarthome.protocol.zwave.Protocol.Message protocol = (com.arcussmarthome.protocol.zwave.Protocol.Message)message.getValue();
 		assert protocol.getType() == com.arcussmarthome.protocol.zwave.Protocol.SetSchedule.ID: "Not a poll setup message";
 		com.arcussmarthome.protocol.zwave.Protocol.SetSchedule psched = com.arcussmarthome.protocol.zwave.Protocol.SetSchedule.serde().nettySerDe().decode( Unpooled.wrappedBuffer(protocol.getPayload()) );
		...
		com.arcussmarthome.protocol.zwave.Protocol.Schedule schedule[] = psched.getSchedule();
