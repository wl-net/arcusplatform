...
import com.arcussmarthome.driver.event.DeviceAssociatedEvent;
import com.arcussmarthome.driver.event.DeviceConnectedEvent;
import com.arcussmarthome.driver.event.DeviceDisassociatedEvent;
import com.arcussmarthome.driver.event.DeviceDisconnectedEvent;
...
import com.arcussmarthome.driver.groovy.zwave.ZWaveProtocolEventMatcher;
import com.arcussmarthome.driver.handler.GetAttributesProvider;
import com.arcussmarthome.driver.metadata.DriverEventMatcher;
import com.arcussmarthome.driver.metadata.EventMatcher;
import com.arcussmarthome.driver.metadata.PlatformEventMatcher;
import com.arcussmarthome.driver.metadata.ProtocolEventMatcher;
...
public class TestGroovyDriverBindings extends GroovyDriverTestCase {
   ...
   public void testEmptyDriver() throws Exception {
      ...
      assertEquals(IrisCollections.setOf(DeviceCapability.NAMESPACE, DeviceAdvancedCapability.NAMESPACE, DeviceConnectionCapability.NAMESPACE, com.arcussmarthome.messages.capability.Capability.NAMESPACE), attributes.get(com.arcussmarthome.messages.capability.Capability.KEY_CAPS));
      assertEquals(
            IrisCollections.setOf(com.arcussmarthome.messages.capability.Capability.NAME, DeviceCapability.NAME, DeviceAdvancedCapability.NAME, DeviceConnectionCapability.NAME),
   ...
   public void testInterpretMetaDataOnly() throws Exception {
      ...
      assertEquals(
            IrisCollections.setOf(DeviceCapability.NAMESPACE, DeviceAdvancedCapability.NAMESPACE, DeviceConnectionCapability.NAMESPACE, DevicePowerCapability.NAMESPACE, SwitchCapability.NAMESPACE, com.arcussmarthome.messages.capability.Capability.NAMESPACE),
            attributes.get(com.arcussmarthome.messages.capability.Capability.KEY_CAPS)
      );
   }
   ...
   public void testInterpretCapabilityObjects() throws Exception {
      ...
      assertEquals(
            IrisCollections.setOf(com.arcussmarthome.messages.capability.Capability.NAME, DeviceCapability.NAME, DeviceAdvancedCapability.NAME, DeviceConnectionCapability.NAME, DevicePowerCapability.NAME, SwitchCapability.NAME, DoorLockCapability.NAME),
            builder.getSupportedCapabilityNames()
      );
