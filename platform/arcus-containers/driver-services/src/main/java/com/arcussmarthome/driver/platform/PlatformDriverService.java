 ...
 */
package com.arcussmarthome.driver.platform;
...
import com.arcussmarthome.core.platform.PlatformRequestDispatcher;
...
import com.arcussmarthome.driver.reflex.ReflexDriverDFA;
...
import com.arcussmarthome.driver.service.DriverService;
import com.arcussmarthome.driver.service.DriverServiceConfig;
...
public class PlatformDriverService implements DriverService {
   ...
   private static void updateKnownAndUnknownDevices(
      ...
      for (Map<String,Object> report : reported) {
         MessageBody sync = MessageBody.buildMessage(com.arcussmarthome.messages.type.SyncDeviceInfo.NAME, report);

         String reportedProtocol = com.arcussmarthome.messages.type.SyncDeviceInfo.getProtocol(sync);
         String protocol = canonicalProtocolAddress(hubId, reportedProtocol);
         Boolean online = com.arcussmarthome.messages.type.SyncDeviceInfo.getOnline(sync);
         Boolean degraded = com.arcussmarthome.messages.type.SyncDeviceInfo.getDegraded(sync);
         Map<String,Object> attrs = com.arcussmarthome.messages.type.SyncDeviceInfo.getAttrs(sync);
   ...
   *************************************************************************/
   ...
   public void syncDegradedDevices(String hubId, UUID place, List<Device> devices, List<Map<String,Object>> reported) {
      ...
      for (Map<String,Object> report : reported) {
         try {
            MessageBody sync = MessageBody.buildMessage(com.arcussmarthome.messages.type.DegradedInfo.NAME, report);

            String reportedProtocol = com.arcussmarthome.messages.type.DegradedInfo.getProtocol(sync);
            String protocol = canonicalProtocolAddress(hubId, reportedProtocol);
            Boolean degraded = com.arcussmarthome.messages.type.DegradedInfo.getDegraded(sync);
