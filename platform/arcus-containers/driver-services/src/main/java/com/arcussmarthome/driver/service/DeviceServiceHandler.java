...
import com.arcussmarthome.driver.service.DeviceService.CreateDeviceRequest;
import com.arcussmarthome.io.json.JSON;
import com.arcussmarthome.messages.MessageBody;
import com.arcussmarthome.messages.MessageConstants;
import com.arcussmarthome.messages.PlatformMessage;
import com.arcussmarthome.messages.address.Address;
import com.arcussmarthome.messages.address.HubAddress;
import com.arcussmarthome.messages.address.HubServiceAddress;
...
public class DeviceServiceHandler extends AbstractPlatformService {
   ...
   private final int syncSizeWarning;
    ...
    public MessageBody handleRequest(PlatformMessage message) throws Exception {
        ...
        switch (type) {
            ...
            case com.arcussmarthome.messages.service.DeviceService.SyncDevicesRequest.NAME:
            ...
            case LEGACY_DEVICESYNC_NAMESPACE:
                ...
                if (com.arcussmarthome.messages.service.DeviceService.SyncDevicesResponse.NAME.equals(m.getMessageType()))
   ...
   protected void handleEvent(PlatformMessage message) throws Exception {
      ...
      case HubAdvancedCapability.GetDeviceInfoResponse.NAME:
         ...
         break;
		case com.arcussmarthome.messages.service.DeviceService.DevicesDegradedEvent.NAME:
   ...
   public MessageBody syncDevices(PlatformMessage msg, MessageBody request) {
      ...
      UUID place = IrisUUID.fromString(com.arcussmarthome.messages.service.DeviceService.SyncDevicesRequest.getPlaceId(request));
      ...
      try {
         String reportedDevices = com.arcussmarthome.messages.service.DeviceService.SyncDevicesRequest.getDevices(request);
         Integer reflexVersion = com.arcussmarthome.messages.service.DeviceService.SyncDevicesRequest.getReflexVersion(request);
         ...
         try {
            ...
            return com.arcussmarthome.messages.service.DeviceService.SyncDevicesResponse.builder()
   ...
   public void syncDegradedDevices(PlatformMessage msg, MessageBody request) {
      ...
      UUID place = UUID.fromString(com.arcussmarthome.messages.service.DeviceService.DevicesDegradedEvent.getPlaceId(request));
      Errors.assertPlaceMatches(msg, place);
      ...
      try {
         String reportedDevices = com.arcussmarthome.messages.service.DeviceService.DevicesDegradedEvent.getDevices(request);
         List<Map<String,Object>> reportedStates = decompress(reportedDevices, List.class);
