...
import com.arcussmarthome.driver.reflex.ReflexActionForward;
import com.arcussmarthome.driver.reflex.ReflexDefinition;
import com.arcussmarthome.driver.reflex.ReflexMatchLifecycle;
import com.arcussmarthome.driver.service.TestDriverModule;
import com.arcussmarthome.driver.service.matcher.DiscoveryAlgorithm;
import com.arcussmarthome.driver.service.matcher.SortedDiscoveryAlgorithmFactory;
...
public class TestMapDriverRegistry extends IrisMockTestCase {
	...
	public void testDriverMatchesOne() {
		...
		assertEquals(new DriverId("Driver2", com.arcussmarthome.model.Version.UNVERSIONED), registry.findDriverFor("general", attributes, 0).getDriverId());
	}
	...
	public void testDriverMatchesAll() {
		...
		assertEquals(new DriverId("Driver1", new com.arcussmarthome.model.Version(2)), registry.findDriverFor("general", attributes, 0).getDriverId());
		assertEquals(new DriverId("Driver1", new com.arcussmarthome.model.Version(4)), registry.findDriverFor("beta", attributes, 0).getDriverId());
		assertEquals(new DriverId("Driver1", new com.arcussmarthome.model.Version(5)), registry.findDriverFor("beta", attributes, 1).getDriverId());
	...
	public void testLoadDriverById() {
		assertEquals(Driver1.class, registry.loadDriverById("Driver1", com.arcussmarthome.model.Version.UNVERSIONED).getClass());
		assertEquals(Driver1V1.class, registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(1)).getClass());
		assertEquals(Driver1V2.class, registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(2)).getClass());
		assertEquals(Driver1V3.class, registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(3)).getClass());
		assertEquals(Driver1V4.class, registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(4)).getClass());
		assertEquals(Driver1V5.class, registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(5)).getClass());
		assertEquals(Driver2.class,	registry.loadDriverById("Driver2", com.arcussmarthome.model.Version.UNVERSIONED).getClass());

		assertNull(registry.loadDriverById("Driver1", new com.arcussmarthome.model.Version(6)));
	}
	...
	public static class Driver1V3 extends AbstractDriverStub {
		...
		@Override
		public DriverId getDriverId() {
			return new DriverId("Driver1", new com.arcussmarthome.model.Version(3));
		}
	}
	...
	public static class Driver1V4 extends AbstractDriverStub {
		...
		@Override
		public DriverId getDriverId() {
			return new DriverId("Driver1", new com.arcussmarthome.model.Version(4));
		}
	}
	...
	public static class Driver1V5 extends AbstractDriverStub {
		...
		@Override
		public DriverId getDriverId() {
			return new DriverId("Driver1", new com.arcussmarthome.model.Version(5));
		}
	}
	...
	public static class FallbackDriver extends DriverStub {
		...
		@Override
		public DriverId getDriverId() {
			return new DriverId("_" + getClass().getSimpleName(), com.arcussmarthome.model.Version.UNVERSIONED);
		}
	}
