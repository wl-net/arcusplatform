 ...
 *
 */
package com.arcussmarthome.capability;
...
import com.arcussmarthome.capability.TestReflectiveCapabilityDriver.TestCapabilityDriver;
...
public class TestReflectiveCapabilityDriver extends IrisMockTestCase {
   ...
   public void replayMock() {
	...
	public void testAnnotatedClass() {
		...
		assertEquals(new com.arcussmarthome.model.Version(3), driver.getVersion());
