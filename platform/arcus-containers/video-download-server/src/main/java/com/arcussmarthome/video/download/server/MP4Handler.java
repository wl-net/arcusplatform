 ...
 */
package com.arcussmarthome.video.download.server;

import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_CLIENT_CLOSED_CHANNEL;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_EXP_NULL;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_FAIL;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_ID_BAD;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_REJECTED;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_REQUEST_DOES_EXIST;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_SIG_NULL;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_SLOW_CLIENT_WAIT;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_START_FAIL;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_SUCCESS;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_URL_BAD;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_UUID_BAD;
import static com.arcussmarthome.video.download.server.VideoDownloadMetrics.DOWNLOAD_VALIDATION_FAILED;
...
import com.arcussmarthome.media.MP4Convert;
...
import com.arcussmarthome.video.download.server.dao.VideoDownloadDao;
import com.arcussmarthome.video.download.server.dao.VideoDownloadSession;
import com.arcussmarthome.video.recording.VideoRecordingFileName;
