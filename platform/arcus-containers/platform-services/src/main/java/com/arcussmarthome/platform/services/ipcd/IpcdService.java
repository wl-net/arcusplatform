 ...
 */
package com.arcussmarthome.platform.services.ipcd;
...
import com.arcussmarthome.messages.service.IpcdService.DeviceConnectedEvent;
import com.arcussmarthome.messages.service.IpcdService.DeviceHeartBeatEvent;
import com.arcussmarthome.messages.service.IpcdService.FindDeviceRequest;
import com.arcussmarthome.messages.service.IpcdService.FindDeviceResponse;
import com.arcussmarthome.messages.service.IpcdService.ForceUnregisterRequest;
import com.arcussmarthome.messages.service.IpcdService.ForceUnregisterResponse;
import com.arcussmarthome.messages.service.IpcdService.ListDeviceTypesRequest;
import com.arcussmarthome.messages.service.IpcdService.ListDeviceTypesResponse;
import com.arcussmarthome.messages.services.PlatformConstants;
import com.arcussmarthome.messages.type.IpcdDeviceType;
import com.arcussmarthome.platform.services.ipcd.registry.IpcdRegistry;
...
public class IpcdService extends AbstractPlatformMessageListener {
   ...
   private final BeanAttributesTransformer<com.arcussmarthome.messages.model.Device> devTransformer;
   ...
   public IpcdService(
         ...
         DeviceDAO devDao,
         BeanAttributesTransformer<com.arcussmarthome.messages.model.Device> devTransformer,
   ...
   private MessageBody handleFindDevice(MessageBody body) {
      ...
      com.arcussmarthome.messages.model.Device dev = devDao.findByProtocolAddress(protocolAddress.getRepresentation());
   ...
   private MessageBody handleForceUnregister(MessageBody body) {
      ...
      if(IpcdDevice.RegistrationState.UNREGISTERED != device.getRegistrationState()) {
         com.arcussmarthome.messages.model.Device dev = devDao.findByProtocolAddress(protocolAddress);
         if(dev != null) {
   ...
   private void forceRemove(com.arcussmarthome.messages.model.Device dev) {
   ...
   private Map<String, Object> createIpcdDev(IpcdDevice ipcdDev) {
      com.arcussmarthome.messages.type.IpcdDevice d = new com.arcussmarthome.messages.type.IpcdDevice();
