 ...
 */
package com.arcussmarthome.platform.services.ipcd.registry;
...
import com.arcussmarthome.core.protocol.ipcd.exceptions.DeviceNotFoundException;
import com.arcussmarthome.core.protocol.ipcd.exceptions.PlaceMismatchException;
...
import com.arcussmarthome.platform.partition.PartitionChangedEvent;
...
import com.arcussmarthome.platform.services.ipcd.IpcdService;
...
import com.arcussmarthome.protocol.ipcd.IpcdDeviceTypeRegistry;
...
public class IpcdRegistry implements PartitionListener {
   ...
   private static final Address ADDRESS = Address.platformService(com.arcussmarthome.messages.service.IpcdService.NAMESPACE);
   ...
   public MessageBody registerDevice(MessageBody body, String placeId) {
      ...
      List<com.arcussmarthome.protocol.ipcd.message.model.Device> devices = createDevicesFromBody(body);

      String protocolAddress = null;
      DeviceNotFoundException lastDnfe = null;
      PlaceMismatchException lastPme = null;
      com.arcussmarthome.protocol.ipcd.message.model.Device claimedDevice = null;

      boolean alreadyPairedAtPlace = false;
      for (com.arcussmarthome.protocol.ipcd.message.model.Device device : devices) {
         try {
   ...
   public void onConnected(PlatformMessage message) {
      ...
      String protocolAddress = com.arcussmarthome.messages.service.IpcdService.DeviceConnectedEvent.getProtocolAddress(body);
   ...
   public void onHeartBeat(PlatformMessage message) {
      ...
      Integer partitionId = com.arcussmarthome.messages.service.IpcdService.DeviceHeartBeatEvent.getPartitionId(body);
      if(partitionId == null) {
         logger.warn("heartbeat did not contain a partition id, ignoring");
         return;
      }
      Set<String> protocolAddresses = com.arcussmarthome.messages.service.IpcdService.DeviceHeartBeatEvent.getConnectedDevices(body);
   ...
   private List<com.arcussmarthome.protocol.ipcd.message.model.Device> createDevicesFromBody(MessageBody body) {
      ...
      List<com.arcussmarthome.protocol.ipcd.message.model.Device> devices = IpcdDeviceTypeRegistry.INSTANCE.createDeviceForV1Type(devType, sn);
   ...
   private void issueAddDevice(com.arcussmarthome.protocol.ipcd.message.model.Device d, String protocolAddress, Place place) {
   ...
   private PlatformMessage createAddDevice(com.arcussmarthome.protocol.ipcd.message.model.Device d, String protocolAddress, Place place) {
   ...
   private void emitRegistered(String protocolAddress, UUID accountId, UUID placeId, String population, String driverAddress) {
      emitEvent(com.arcussmarthome.messages.service.IpcdService.DeviceRegisteredEvent.builder()
   ...
   private void emitUnregistered(String protocolAddress, UUID placeId) {
      emitEvent(com.arcussmarthome.messages.service.IpcdService.DeviceUnregisteredEvent.builder()
            .withProtocolAddress(protocolAddress)
   ...
   private void emitClaimed(String protocolAddress, UUID accountId, UUID placeId, String population) {
      emitEvent(com.arcussmarthome.messages.service.IpcdService.DeviceClaimedEvent.builder()
            .withAccountId(String.valueOf(accountId))
            .withPlaceId(String.valueOf(placeId))
            .withProtocolAddress(protocolAddress)
            .build(), placeId, population);
