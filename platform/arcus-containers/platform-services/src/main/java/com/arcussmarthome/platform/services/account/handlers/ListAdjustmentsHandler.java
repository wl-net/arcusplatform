...
import com.arcussmarthome.billing.exception.BillingEntityNotFoundException;
...
public class ListAdjustmentsHandler implements ContextualRequestMessageHandler<Account>  {
    ...
    private Map<String, Object> convertAdjustmentToAttributes(Adjustment adjustment) {
        ...
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_ACCOUNTINGCODE, adjustment.getAccountingCode());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_ADJUSTMENTID, adjustment.getAdjustmentID());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_ADJUSTMENTTYPE, adjustment.getAdjustmentType());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_CREATEDAT, adjustment.getCreatedAt());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_DESCRIPTION, adjustment.getDescription());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_DISCOUNTINDOLLARS, convertCentStringToDollars(adjustment.getDiscountInCents()));
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_ENDDATE, adjustment.getEndDate());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_ORIGIN, adjustment.getOrigin());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_PRODUCTCODE, adjustment.getProductCode());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_STATE, adjustment.getState());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_STARTDATE, adjustment.getStartDate());
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_TAXINDOLLARS, convertCentStringToDollars(adjustment.getTaxInCents()));
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_TOTALINDOLLARS,convertCentStringToDollars(adjustment.getTotalInCents()));
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_UNITINDOLLARS, convertCentStringToDollars(adjustment.getUnitAmountInCents()));
        map.put(com.arcussmarthome.messages.type.Adjustment.ATTR_QUANTITY, StringUtils.isNotEmpty(adjustment.getQuantity())?new Integer (adjustment.getQuantity()): null);
