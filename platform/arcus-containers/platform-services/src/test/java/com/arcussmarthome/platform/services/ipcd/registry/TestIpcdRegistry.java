...
import com.arcussmarthome.platform.partition.simple.SimplePartitioner;
...
public class TestIpcdRegistry extends IrisMockTestCase {
   ...
   public void TestRegisterDevice_HappyPath() {
      ...
      expect(mockIpcdDeviceDao
            .claimAndGetProtocolAddress(anyObject(com.arcussmarthome.protocol.ipcd.message.model.Device.class), anyObject(UUID.class), eq(place.getId())))
