...
import com.arcussmarthome.billing.client.model.Account;
import com.arcussmarthome.billing.client.model.AccountBalance;
import com.arcussmarthome.billing.client.model.AccountNotes;
import com.arcussmarthome.billing.client.model.Accounts;
import com.arcussmarthome.billing.client.model.Adjustment;
import com.arcussmarthome.billing.client.model.Adjustments;
import com.arcussmarthome.billing.client.model.BillingInfo;
import com.arcussmarthome.billing.client.model.Constants;
import com.arcussmarthome.billing.client.model.Invoice;
import com.arcussmarthome.billing.client.model.Invoices;
import com.arcussmarthome.billing.client.model.PlanAddons;
import com.arcussmarthome.billing.client.model.Plans;
import com.arcussmarthome.billing.client.model.Subscription;
import com.arcussmarthome.billing.client.model.SubscriptionAddon;
import com.arcussmarthome.billing.client.model.Subscriptions;
import com.arcussmarthome.billing.client.model.Transactions;
import com.arcussmarthome.billing.client.model.request.AccountRequest;
import com.arcussmarthome.billing.client.model.request.AdjustmentRequest;
import com.arcussmarthome.billing.client.model.request.InvoiceRefundRequest;
import com.arcussmarthome.billing.client.model.request.SubscriptionRequest;
...
import com.arcussmarthome.platform.subscription.SubscriptionManagerImpl;
...
public abstract class BillingTestCase extends IrisMockTestCase {
   ...
   protected com.arcussmarthome.messages.model.Account account;
   ...
   public com.arcussmarthome.messages.model.Account createAccount(UUID id) {
      com.arcussmarthome.messages.model.Account account = new com.arcussmarthome.messages.model.Account();
      account.setId(id);
   ...
   public Person createPerson(com.arcussmarthome.messages.model.Account account, UUID personId) {
   ...
   public Place createPlace(UUID accountId, UUID placeId, String name) {
      ...
      com.arcussmarthome.messages.model.Account account = accountDao.findById(accountId);
   ...
   protected void verifyAccount(UUID accountId, UUID... places) {
      com.arcussmarthome.messages.model.Account myAccount = accountDao.findById(accountId);
   ...
   public static class FakeAccountDao extends Faker implements AccountDAO {
      private Map<UUID, com.arcussmarthome.messages.model.Account> accounts = new HashMap<>();

      @Override
      public com.arcussmarthome.messages.model.Account save(com.arcussmarthome.messages.model.Account entity) {
         calls.add("save");
      ...
      @Override
      public com.arcussmarthome.messages.model.Account create(
            com.arcussmarthome.messages.model.Account account) {
         calls.add("create");
         return save(account);
      }
      ...
      @Override
      public com.arcussmarthome.messages.model.Account findById(UUID id) {
         calls.add("findById");
         return accounts.get(id);
      }

      @Override
      public void delete(com.arcussmarthome.messages.model.Account entity) {
         calls.add("delete");
      }
      ...
      @Override
      public PagedResults<com.arcussmarthome.messages.model.Account> listAccounts(AccountQuery query) {
        throw new UnsupportedOperationException();
      }

      @Override
      public Stream<com.arcussmarthome.messages.model.Account> streamAll() {
        throw new UnsupportedOperationException();
      }
   }
