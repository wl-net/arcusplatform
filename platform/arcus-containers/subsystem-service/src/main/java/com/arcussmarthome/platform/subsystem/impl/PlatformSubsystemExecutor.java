...
import com.arcussmarthome.common.subsystem.event.SubsystemAddedEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemLifecycleEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemRemovedEvent;
import com.arcussmarthome.common.subsystem.event.SubsystemResponseEvent;
import com.arcussmarthome.common.subsystem.util.PlaceMdcBinder;
...
import com.arcussmarthome.messages.errors.InvalidRequestException;
...
import com.arcussmarthome.messages.service.SubsystemService.ListSubsystemsRequest;
import com.arcussmarthome.messages.service.SubsystemService.ListSubsystemsResponse;
import com.arcussmarthome.platform.subsystem.SubsystemFactory;
...
import com.arcussmarthome.util.Result;
...
public class PlatformSubsystemExecutor implements Consumer<AddressableEvent>, SubsystemExecutor {
   ...
   /**
    * @return
    * @see com.arcussmarthome.core.messaging.SingleThreadDispatcher#isRunning()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.core.messaging.SingleThreadDispatcher#getDispatchThreadName()
    */
