...
import com.arcussmarthome.platform.subsystem.placemonitor.config.XMLUtil;
import com.arcussmarthome.platform.subsystem.placemonitor.offlinenotifications.NotificationThresholdsConfig;
...
public class TestJAXBConfig extends IrisTestCase {
   ...
   public void testSchema() {
      Document doc = com.arcussmarthome.io.xml.XMLUtil.parseDocumentDOM("conf/notification-thresholds-config.xml","classpath:/schema/notification-thresholds-config.xsd");
