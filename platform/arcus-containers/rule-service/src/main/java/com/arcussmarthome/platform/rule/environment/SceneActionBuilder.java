...
import com.arcussmarthome.platform.rule.service.SceneCatalogLoader;
import com.arcussmarthome.platform.scene.catalog.SceneCatalog;
...
public class SceneActionBuilder {
   private static final AttributeType TYPE_ACTIONS =
         AttributeTypes.listOf(com.arcussmarthome.messages.type.Action.TYPE);
   ...
   private List<com.arcussmarthome.messages.type.Action> actions;
   ...
   public SceneActionBuilder withActions(List<Map<String, Object>> actions) {
      return withActionTypes((List<com.arcussmarthome.messages.type.Action>) TYPE_ACTIONS.coerce(actions));
   }

   public SceneActionBuilder withActionTypes(List<com.arcussmarthome.messages.type.Action> actions) {
   ...
   public Action buildStrict() throws IllegalStateException {
      ...
      if(actions != null) {
         for(com.arcussmarthome.messages.type.Action action: actions) {
   ...
   private void addAction(com.arcussmarthome.messages.type.Action action, SceneTemplate template, ActionList.Builder builder) {
