 ...
 */
package com.arcussmarthome.video.streaming.server.http;

import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_DOESNT_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_DOES_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_FAIL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_FINAL_SEGMENT_DURATION;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_FINAL_SEGMENT_SIZE;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_FINISHED;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_INPROGRESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_NOID;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_NULL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_SEGMENT_DURATION;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_SEGMENT_NUM;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_SEGMENT_SIZE;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_SUCCESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_PLAYLIST_VALIDATION;
...
import com.arcussmarthome.video.VideoIFrame;
import com.arcussmarthome.video.VideoRecording;
import com.arcussmarthome.video.VideoUtil;
import com.arcussmarthome.video.streaming.server.VideoStreamingServerConfig;
import com.arcussmarthome.video.streaming.server.dao.VideoStreamingDao;
import com.arcussmarthome.video.streaming.server.dao.VideoStreamingSession;
