...
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_DOESNT_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_DOES_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_DURATION;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_FAIL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_FINISHED;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_INPROGRESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_NOID;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_NULL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_NUM;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_SIZE;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_SUCCESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_IFRAME_VALIDATION;
...
import com.arcussmarthome.media.MpegTsH264;
