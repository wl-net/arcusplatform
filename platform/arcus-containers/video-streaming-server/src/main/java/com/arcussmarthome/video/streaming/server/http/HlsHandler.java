...
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_DOESNT_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_DOES_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_FAIL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NOBW;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NOFR;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NOID;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NOIFRAME;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NORES;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NOTENOUGH_SEGMENTS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_NULL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_SUCCESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.HLS_REQUEST_VALIDATION;
...
import com.arcussmarthome.video.AudioCodec;
import com.arcussmarthome.video.VideoCodec;
