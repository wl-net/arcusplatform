...
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_CACHE_HIT;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_CACHE_MISS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_CACHE_WRITE_FAIL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_CACHE_WRITE_SUCCESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_DOESNT_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_DOES_EXIST;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_FAIL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_NOID;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_NOIFRAME;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_NULL;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_SUCCESS;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_TRANSCODE_ERROR;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_TRANSCODE_RESPONSE;
import static com.arcussmarthome.video.streaming.server.VideoStreamingMetrics.JPG_REQUEST_VALIDATION;
