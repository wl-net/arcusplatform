 ...
 */
package com.arcussmarthome.client.server.rest.twilio;

import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.ANSWEREDBY_PARAM_KEY;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.CALL_STATUS_BUSY;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.CALL_STATUS_COMPLETED;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.CALL_STATUS_FAILED;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.CALL_STATUS_NOANSWER;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.CALL_STATUS_PARAM_KEY;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.NOTIFICATION_EVENT_TIME_PARAM_NAME;
import static com.arcussmarthome.platform.notification.provider.ivr.TwilioHelper.NOTIFICATION_ID_PARAM_NAME;
...
import com.arcussmarthome.bridge.server.http.impl.HttpRequestParameters;
