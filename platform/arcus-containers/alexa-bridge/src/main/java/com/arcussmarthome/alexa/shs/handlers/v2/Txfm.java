...
import com.arcussmarthome.alexa.message.v2.error.UnableToGetValueError;
import com.arcussmarthome.alexa.message.v2.error.UnableToSetValueError;
import com.arcussmarthome.alexa.message.v2.error.UnsupportedOperationError;
...
import com.arcussmarthome.alexa.message.v2.request.DecrementColorTemperatureRequest;
import com.arcussmarthome.alexa.message.v2.request.DecrementPercentageRequest;
import com.arcussmarthome.alexa.message.v2.request.DecrementTargetTemperatureRequest;
import com.arcussmarthome.alexa.message.v2.request.DiscoverAppliancesRequest;
import com.arcussmarthome.alexa.message.v2.request.GetLockStateRequest;
import com.arcussmarthome.alexa.message.v2.request.GetTargetTemperatureRequest;
import com.arcussmarthome.alexa.message.v2.request.GetTemperatureReadingRequest;
...
import com.arcussmarthome.alexa.message.v2.request.RequestPayload;
import com.arcussmarthome.alexa.message.v2.request.SetColorRequest;
import com.arcussmarthome.alexa.message.v2.request.SetColorTemperatureRequest;
import com.arcussmarthome.alexa.message.v2.request.SetLockStateRequest;
import com.arcussmarthome.alexa.message.v2.request.SetPercentageRequest;
...
import com.arcussmarthome.alexa.message.v2.response.ColorTemperatureConfirmationPayload;
import com.arcussmarthome.alexa.message.v2.response.DecrementColorTemperatureConfirmation;
import com.arcussmarthome.alexa.message.v2.response.DecrementPercentageConfirmation;
import com.arcussmarthome.alexa.message.v2.response.DecrementTargetTemperatureConfirmation;
import com.arcussmarthome.alexa.message.v2.response.DiscoverAppliancesResponse;
import com.arcussmarthome.alexa.message.v2.response.GetLockStateResponse;
import com.arcussmarthome.alexa.message.v2.response.GetTargetTemperatureResponse;
import com.arcussmarthome.alexa.message.v2.response.GetTemperatureReadingResponse;
...
import com.arcussmarthome.alexa.message.v2.response.ResponsePayload;
import com.arcussmarthome.alexa.message.v2.response.SetColorConfirmation;
import com.arcussmarthome.alexa.message.v2.response.SetColorTemperatureConfirmation;
import com.arcussmarthome.alexa.message.v2.response.SetLockStateConfirmation;
import com.arcussmarthome.alexa.message.v2.response.SetPercentageConfirmation;
...
import com.arcussmarthome.alexa.shs.ShsMetrics;
...
import com.arcussmarthome.messages.type.AlexaCapability;
import com.arcussmarthome.messages.type.AlexaColor;
import com.arcussmarthome.messages.type.AlexaEndpoint;
import com.arcussmarthome.messages.type.AlexaPropertyReport;
import com.arcussmarthome.messages.type.AlexaTemperature;
