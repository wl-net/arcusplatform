...
import com.arcussmarthome.alexa.message.v2.Payload;
import com.arcussmarthome.alexa.message.v2.error.BridgeOfflineError;
import com.arcussmarthome.alexa.message.v2.error.DriverInternalError;
import com.arcussmarthome.alexa.message.v2.error.ErrorPayload;
import com.arcussmarthome.alexa.message.v2.error.ErrorPayloadException;
import com.arcussmarthome.alexa.message.v2.error.ExpiredAccessTokenError;
import com.arcussmarthome.alexa.message.v2.error.InvalidAccessTokenError;
import com.arcussmarthome.alexa.message.v2.error.NotSupportedInCurrentModeError;
import com.arcussmarthome.alexa.message.v2.error.RateLimitExceededError;
import com.arcussmarthome.alexa.message.v2.error.TargetFirmwareOutdatedError;
import com.arcussmarthome.alexa.message.v2.error.TargetHardwareMalfunctionError;
import com.arcussmarthome.alexa.message.v2.error.TargetOfflineError;
...
import com.arcussmarthome.alexa.message.v2.error.UnsupportedTargetError;
import com.arcussmarthome.alexa.message.v2.error.UnsupportedTargetSettingError;
...
import com.arcussmarthome.alexa.message.v2.request.HealthCheckRequest;
...
import com.arcussmarthome.messages.type.AlexaValidRange;
