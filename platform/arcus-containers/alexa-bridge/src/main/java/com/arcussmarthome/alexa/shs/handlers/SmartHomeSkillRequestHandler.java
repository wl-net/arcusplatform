 ...
 */
package com.arcussmarthome.alexa.shs.handlers;
...
import com.arcussmarthome.alexa.serder.SerDer;
...
import com.arcussmarthome.bridge.server.http.impl.RequestHandlerImpl;
import com.arcussmarthome.bridge.server.http.impl.auth.AlwaysAllow;
import com.arcussmarthome.bridge.server.http.impl.matcher.WildcardMatcher;
