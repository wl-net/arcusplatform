...
import static com.arcussmarthome.video.service.VideoServiceMetrics.ADD_TAGS_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.ADD_TAGS_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.ADD_TAGS_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_ALL_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_ALL_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_ALL_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_RECORDING_ALREADY_DELETED;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_RECORDING_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_RECORDING_DOESNT_EXIST;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_RECORDING_INPROGRESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DELETE_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DOWNLOAD_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DOWNLOAD_RECORDING_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.DOWNLOAD_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_ATTRIBUTES_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_ATTRIBUTES_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_ATTRIBUTES_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_QUOTA_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_QUOTA_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_QUOTA_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.GET_QUOTA_USED;
import static com.arcussmarthome.video.service.VideoServiceMetrics.LIST_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.LIST_RECORDINGS_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.LIST_RECORDINGS_NUM;
import static com.arcussmarthome.video.service.VideoServiceMetrics.LIST_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.METRICS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.PAGE_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.PAGE_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.QUOTA_ENFORCEMENT_ALLOW;
import static com.arcussmarthome.video.service.VideoServiceMetrics.QUOTA_ENFORCEMENT_DENY;
import static com.arcussmarthome.video.service.VideoServiceMetrics.REFRESH_QUOTA_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.REFRESH_QUOTA_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.REMOVE_TAGS_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.REMOVE_TAGS_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.REMOVE_TAGS_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.SET_ATTRIBUTES_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.SET_ATTRIBUTES_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.SET_ATTRIBUTES_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_INCIDENT;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_OTHER;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_PERSON;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_RULE;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_RECORDING_SCENE;
import static com.arcussmarthome.video.service.VideoServiceMetrics.START_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.STOP_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.STOP_RECORDING_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.STOP_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceMetrics.VIEW_FAIL;
import static com.arcussmarthome.video.service.VideoServiceMetrics.VIEW_RECORDING_BAD;
import static com.arcussmarthome.video.service.VideoServiceMetrics.VIEW_SUCCESS;
import static com.arcussmarthome.video.service.VideoServiceUtil.getAccountId;
import static com.arcussmarthome.video.service.VideoServiceUtil.getPlaceId;
import static com.arcussmarthome.video.service.VideoServiceUtil.getRecordingId;
...
import com.arcussmarthome.core.messaging.SingleThreadDispatcher;
import com.arcussmarthome.core.platform.AbstractPlatformMessageListener;
import com.arcussmarthome.core.platform.PlatformDispatcher;
...
import com.arcussmarthome.messages.capability.CameraCapability;
...
import com.arcussmarthome.messages.service.VideoService.DeleteAllRequest;
import com.arcussmarthome.messages.service.VideoService.GetFavoriteQuotaRequest;
import com.arcussmarthome.messages.service.VideoService.GetFavoriteQuotaResponse;
import com.arcussmarthome.messages.service.VideoService.GetQuotaRequest;
import com.arcussmarthome.messages.service.VideoService.GetQuotaResponse;
import com.arcussmarthome.messages.service.VideoService.ListRecordingsRequest;
import com.arcussmarthome.messages.service.VideoService.ListRecordingsResponse;
import com.arcussmarthome.messages.service.VideoService.PageRecordingsRequest;
import com.arcussmarthome.messages.service.VideoService.QuotaReportEvent;
import com.arcussmarthome.messages.service.VideoService.RefreshQuotaRequest;
import com.arcussmarthome.messages.service.VideoService.RefreshQuotaResponse;
import com.arcussmarthome.messages.service.VideoService.StartRecordingRequest;
import com.arcussmarthome.messages.service.VideoService.StartRecordingResponse;
import com.arcussmarthome.messages.service.VideoService.StopRecordingRequest;
import com.arcussmarthome.messages.service.VideoService.StopRecordingResponse;
...
import com.arcussmarthome.video.VideoMetadata;
import com.arcussmarthome.video.VideoQuery;
import com.arcussmarthome.video.VideoUtil;
...
import com.arcussmarthome.video.service.handler.PageRecordingsHandler;
import com.arcussmarthome.video.service.handler.QuotaReportListener;
import com.arcussmarthome.video.service.quota.QuotaManager;
...
public class VideoService extends AbstractPlatformMessageListener {
   ...
   public VideoService(
      ...
      this.listeners =
            factory
               ...
               .addAddressMatcher(AddressMatchers.platformService(MessageConstants.SERVICE, com.arcussmarthome.messages.service.VideoService.NAMESPACE))
   ...
   protected MessageBody handleStartRecording(PlatformMessage message, MessageBody req) throws Exception {
      ...
      PlatformMessage msg = PlatformMessage.buildRequest(
            startStream,
            Address.platformService(com.arcussmarthome.messages.service.VideoService.NAMESPACE),
   ...
   protected MessageBody handleDeleteAll(PlatformMessage message, MessageBody body) throws Exception{
      ...
      MessageBody eventBody = com.arcussmarthome.messages.service.VideoService.RecordingsDeletedEvent.builder()
      ...
      return com.arcussmarthome.messages.service.VideoService.DeleteAllResponse.instance();
   }
