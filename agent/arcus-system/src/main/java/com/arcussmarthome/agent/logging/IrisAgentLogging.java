 ...
 */
package com.arcussmarthome.agent.logging;
...
public final class IrisAgentLogging {
   ...
   public static IrisAgentAppender getInMemoryAppender() {
      ...
      return (com.arcussmarthome.agent.logging.IrisAgentAppender)logger.getAppender("MEMORY");
   }
   ...
   public static String getInMemoryLogs(boolean compress) {
      Logger logger = (ch.qos.logback.classic.Logger)LoggerFactory.getLogger(org.slf4j.Logger.ROOT_LOGGER_NAME);
      IrisAgentAppender appender = (com.arcussmarthome.agent.logging.IrisAgentAppender)logger.getAppender("MEMORY");
      if (appender == null) {
         return "";
      }
