 ...
 */
package com.arcussmarthome.protocol.zigbee;
...
import com.arcussmarthome.protoc.runtime.ProtocMessage;
import com.arcussmarthome.protoc.runtime.ProtocMessageSerDe;
import com.arcussmarthome.protoc.runtime.ProtocSerDe;
...
import com.arcussmarthome.protocol.constants.ZigbeeConstants;
...
public enum ZigbeeProtocol implements Protocol<ZigbeeMessage.Protocol>, ZigbeeConstants {
   ...
   private static final ProtocMessageSerDe[] ZDP_SERDES = new ProtocMessageSerDe[] {
      com.arcussmarthome.protocol.zigbee.zdp.Bind.serde(),
      com.arcussmarthome.protocol.zigbee.zdp.Discovery.serde(),
      com.arcussmarthome.protocol.zigbee.zdp.Mgmt.serde(),
   };

   private static final ProtocMessageSerDe[] ZCL_SERVER_SERDES = new ProtocMessageSerDe[] {
      com.arcussmarthome.protocol.zigbee.zcl.Alarms.serverSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.ApplianceAlerts.clientSerDe(),
      ...
      com.arcussmarthome.protocol.zigbee.zcl.DoorLock.serverSerDe(),
      //com.iris.protocol.zigbee.zcl.Fan.serverSerDe(),
      //com.iris.protocol.zigbee.zcl.FlowMeasurement.serverSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Groups.serverSerDe(),
      //com.iris.protocol.zigbee.zcl.HumidityMeasurement.serverSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.IasAce.serverSerDe(),
      //com.iris.protocol.zigbee.zcl.IasWd.serverSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.IasZone.serverSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Identify.serverSerDe(),
      ...
      com.arcussmarthome.protocol.zigbee.zcl.Scenes.serverSerDe(),
   ...
   private static final ProtocMessageSerDe[] ZCL_CLIENT_SERDES = new ProtocMessageSerDe[] {
      com.arcussmarthome.protocol.zigbee.zcl.Alarms.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.ApplianceAlerts.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.Ballast.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Basic.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Color.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.Dehumidification.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.DeviceTemperature.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.DoorLock.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.Fan.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.FlowMeasurement.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Groups.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.HumidityMeasurement.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.IasAce.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.IasWd.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.IasZone.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Identify.clientSerDe(),
      ...
      com.arcussmarthome.protocol.zigbee.zcl.Level.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.Metering.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.OccupancySensing.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.OnOff.clientSerDe(),
      ...
      com.arcussmarthome.protocol.zigbee.zcl.Scenes.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.Shade.clientSerDe(),
      //com.iris.protocol.zigbee.zcl.TemperatureMeasurement.clientSerDe(),
      com.arcussmarthome.protocol.zigbee.zcl.Thermostat.clientSerDe(),
   ...
   public static ProtocSerDe<? extends ProtocMessage> getZclGeneralSerDe(ZigbeeMessage.Zcl msg) {
      ProtocSerDe<? extends ProtocMessage> result = com.arcussmarthome.protocol.zigbee.zcl.General.serde().serde(msg.getZclMessageId());
      if (result != null) {
         return result;
      }
