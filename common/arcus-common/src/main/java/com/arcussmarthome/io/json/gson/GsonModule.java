...
import com.arcussmarthome.io.json.JsonModule;
...
public class GsonModule extends AbstractModule {
   ...
   protected void configure() {
      bind(com.arcussmarthome.io.json.JsonSerializer.class).to(GsonSerializerImpl.class);
      bind(com.arcussmarthome.io.json.JsonDeserializer.class).to(GsonDeserializerImpl.class);
