...
public final class NetworkClocks {
   ...
   public static com.arcussmarthome.network.ControlledNetworkClock controlled() {
   ...
   private static class ControlledNetworkClock implements com.arcussmarthome.network.ControlledNetworkClock {
      private long current;
