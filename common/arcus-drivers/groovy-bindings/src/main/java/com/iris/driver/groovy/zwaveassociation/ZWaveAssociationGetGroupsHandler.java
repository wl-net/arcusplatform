...
/**
 * Handles zwda:GetSupportedGroups requests.
 * Sends Association Groupings Get (0x85/0x05).
 */
public class ZWaveAssociationGetGroupsHandler implements ContextualEventHandler<Object> {
   private static final Logger log = LoggerFactory.getLogger(ZWaveAssociationGetGroupsHandler.class);
   ...
   public boolean handleEvent(DeviceDriverContext context, Object event) throws Exception {
      ...
      context.respondToPlatform(ZWaveDirectAssociationCapability.GetSupportedGroupsResponse.builder()
            .withStatus("PENDING")
            .build());
      return true;
   }
