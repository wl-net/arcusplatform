...
import com.arcussmarthome.driver.groovy.reflex.ReflexMatchContext;
...
import com.arcussmarthome.protoc.runtime.ProtocStruct;
...
public enum ZigbeeReflex {
   ...
   public ProtocMessage report(List<Map<String,Object>> configs) {
      try {
         ...
         int i = 0;
         com.arcussmarthome.protocol.zigbee.zcl.General.ZclAttributeReportingConfigurationRecord[] recs = new com.arcussmarthome.protocol.zigbee.zcl.General.ZclAttributeReportingConfigurationRecord[configs.size()];
         for (Map<String,Object> config : configs) {
            ...
            if (rchange != null) {
               recs[i++] = com.arcussmarthome.protocol.zigbee.zcl.General.ZclAttributeReportingConfigurationRecord.builder()
                  .setDirection(0)
         ...
         ProtocMessage crep = com.arcussmarthome.protocol.zigbee.zcl.General.ZclConfigureReporting.builder()
            .setAttributes(recs)
            .create();
   ...
   public ProtocMessage write(List<Map<String,Object>> configs) {
      try {
         ...
         int i = 0;
         com.arcussmarthome.protocol.zigbee.zcl.General.ZclWriteAttributeRecord[] attrs = new com.arcussmarthome.protocol.zigbee.zcl.General.ZclWriteAttributeRecord[configs.size()];
         for (Map<String,Object> config : configs) {
            int attr = -1;
            if (config.containsKey("attr")) {
               attr = ((Number)config.get("attr")).intValue();
            ...
            attrs[i++] = com.arcussmarthome.protocol.zigbee.zcl.General.ZclWriteAttributeRecord.builder()
               .setAttributeIdentifier(attr)
         ...
         ProtocMessage read = com.arcussmarthome.protocol.zigbee.zcl.General.ZclWriteAttributes.builder()
            .setAttributes(attrs)
            .create();
   ...
   public ProtocMessage read(List<Map<String,Object>> configs) {
      try {
         ...
         ProtocMessage read = com.arcussmarthome.protocol.zigbee.zcl.General.ZclReadAttributes.builder()
            .setAttributes(attrs)
            .create();
