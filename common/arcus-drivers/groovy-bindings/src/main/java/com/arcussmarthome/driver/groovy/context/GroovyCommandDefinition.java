...
public class GroovyCommandDefinition extends GroovyObjectSupport {
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getName()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getNamespace()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getCommand()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getDescription()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getReturnParameters()
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.device.model.CommandDefinition#getInputArguments()
    */
