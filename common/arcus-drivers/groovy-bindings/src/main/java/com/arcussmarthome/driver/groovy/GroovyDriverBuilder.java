...
import com.arcussmarthome.capability.key.NamedKey;
...
import com.arcussmarthome.driver.groovy.context.SetAttributesHandlerDefinition;
import com.arcussmarthome.driver.groovy.handler.RequestEventHandler;
import com.arcussmarthome.driver.groovy.handler.SetAttributesDefinitionConsumer;
...
import com.arcussmarthome.driver.handler.GetAttributesHandler;
import com.arcussmarthome.driver.handler.GetAttributesProvider;
import com.arcussmarthome.driver.handler.GetReflexesHandler;
import com.arcussmarthome.driver.handler.MessageBodyHandler;
import com.arcussmarthome.driver.handler.SetAttributesConsumer;
import com.arcussmarthome.driver.handler.SetAttributesHandler;
...
import com.arcussmarthome.driver.reflex.ReflexRunMode;
...
public class GroovyDriverBuilder extends GroovyBuilder {
   ...
   protected ContextualEventHandler<PlatformMessage> createPlatformMessageHandler(DeviceDriverDefinition def) {
      ...
      try {
         ...
         builder.addHandler(
               NamespacedKey.parse(com.arcussmarthome.messages.capability.Capability.CMD_GET_ATTRIBUTES),
               createGetAttributesHandler());
         builder.addHandler(
               NamespacedKey.parse(com.arcussmarthome.messages.capability.Capability.CMD_SET_ATTRIBUTES),
               createSetAttributesHandler());
         builder.addHandler(
               NamespacedKey.parse(com.arcussmarthome.messages.capability.DeviceAdvancedCapability.GetReflexesRequest.NAME),
