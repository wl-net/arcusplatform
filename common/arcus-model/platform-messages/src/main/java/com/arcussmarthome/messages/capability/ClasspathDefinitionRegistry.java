 ...
 */
package com.arcussmarthome.messages.capability;
...
import com.arcussmarthome.capability.definition.BaseDefinitionRegistry;
import com.arcussmarthome.capability.definition.Definition;
import com.arcussmarthome.capability.definition.DefinitionRegistry;
import com.arcussmarthome.capability.definition.EventDefinition;
import com.arcussmarthome.capability.definition.MergeableDefinition;
import com.arcussmarthome.capability.definition.ServiceDefinition;
import com.arcussmarthome.capability.definition.TypeDefinition;
import com.arcussmarthome.capability.reader.GenericDefinitionReader;
...
public class ClasspathDefinitionRegistry implements DefinitionRegistry {
    ...
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getCapability(java.lang.String)
    */
   public com.arcussmarthome.capability.definition.CapabilityDefinition getCapability(
   ...
   /**
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getCapabilities()
    */
   public Collection<com.arcussmarthome.capability.definition.CapabilityDefinition> getCapabilities() {
    ...
    * @param nameOrNamespace
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getService(java.lang.String)
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getServices()
    */
    ...
    * @param name
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getStruct(java.lang.String)
    */
   ...
   /**
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getStructs()
    */
    ...
    * @param name
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getEvent(java.lang.String)
    */
    ...
    * @param name
    * @return
    * @see com.arcussmarthome.capability.definition.DefinitionRegistry#getAttribute(java.lang.String)
    */
   public com.arcussmarthome.capability.definition.AttributeDefinition getAttribute(
         String name) {
