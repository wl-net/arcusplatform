...
import com.arcussmarthome.device.model.*;
import com.arcussmarthome.model.type.*;
...
public class DefinitionTransformCapabilityRegistry implements CapabilityRegistry {
   ...
   public AttributeDefinition getAttributeDefinition(String name) {
	...
	private void ingest(Collection<com.arcussmarthome.capability.definition.CapabilityDefinition> definitions) {
      for(com.arcussmarthome.capability.definition.CapabilityDefinition def: definitions) {
   ...
   private Map<String, AttributeDefinition> transformAttributes(String namespace, List<com.arcussmarthome.capability.definition.AttributeDefinition> attributes) {
      Map<String, AttributeDefinition> transformed = new HashMap<String, AttributeDefinition>(2 * Math.max(1, attributes.size()));
      for(com.arcussmarthome.capability.definition.AttributeDefinition attribute: attributes) {
   ...
   private Map<String, EventDefinition> transformEvents(String namespace, List<com.arcussmarthome.capability.definition.EventDefinition> events) {
      Map<String, EventDefinition> transformed = new HashMap<String, EventDefinition>(2 * Math.max(1, events.size()));
      for(com.arcussmarthome.capability.definition.EventDefinition event: events) {
   ...
   private AttributeDefinition transform(String namespace, com.arcussmarthome.capability.definition.AttributeDefinition attribute) {
   ...
   private EventDefinition transform(String namespace, com.arcussmarthome.capability.definition.EventDefinition event) {
