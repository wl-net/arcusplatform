...
public static class GetAttributesRequest {
   ...
   public static final com.arcussmarthome.capability.definition.AttributeType TYPE_NAMES =
         com.arcussmarthome.capability.definition.AttributeTypes.setOf(AttributeTypes.stringType());

   public static java.util.Set<java.lang.String> getNames(com.arcussmarthome.messages.MessageBody message) {
      if(message == null) { 
         return null;
      }
...
public static class AddTagsRequest {
   ...
   public static final com.arcussmarthome.capability.definition.AttributeType TYPE_TAGS =
      com.arcussmarthome.capability.definition.AttributeTypes.setOf(AttributeTypes.stringType());

   /** The tags to add */
   public static java.util.Set<java.lang.String> getTags(com.arcussmarthome.messages.MessageBody message) {
      if(message == null) { 
         return null;
      }
...
public static class AddTagsResponse {
   ...
   public static com.arcussmarthome.messages.MessageBody instance() {
      return com.arcussmarthome.messages.MessageBody.emptyMessage();
   }
