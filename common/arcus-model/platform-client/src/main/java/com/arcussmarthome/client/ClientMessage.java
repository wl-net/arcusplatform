...
import com.arcussmarthome.client.event.ClientEventFactory;
import com.arcussmarthome.client.event.DefaultClientEventFactory;
...
public class ClientMessage {
   ...
   private static ClientEventFactory loadFactory() {
      try {
         return (ClientEventFactory) Class.forName("com.arcussmarthome.client.GeneratedEventFactory").newInstance();
      }
      catch(Exception e) {
