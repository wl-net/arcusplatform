 ...
 * 
 */
package com.arcussmarthome.client.capability;
...
import com.arcussmarthome.capability.definition.Definitions;
import com.arcussmarthome.client.ErrorEvent;
import com.arcussmarthome.client.annotation.GetAttribute;
...
public interface Capability {
   ...
   @com.arcussmarthome.client.annotation.Command(value=AddTagsRequest.NAME, parameters={ AddTagsRequest.ATTR_TAGS })
   public com.arcussmarthome.client.event.ClientFuture<AddTagsResponse> addTags(java.util.Collection<java.lang.String> tags);
   
   /** Removes the given tags from base:tags */
   @com.arcussmarthome.client.annotation.Command(value=RemoveTagsRequest.NAME, parameters={ RemoveTagsRequest.ATTR_TAGS })
   public com.arcussmarthome.client.event.ClientFuture<RemoveTagsResponse> removeTags(java.util.Collection<java.lang.String> tags);
   
   /** Adds the given tags to base:tags */
   public static class AddTagsRequest extends com.arcussmarthome.client.ClientRequest {
   ...
   public static class AddTagsResponse extends com.arcussmarthome.client.ClientEvent {
      ...
      public AddTagsResponse(com.arcussmarthome.client.ClientEvent copy) {
         super(copy.getType(), copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }
   }
   
   /** Removes the given tags from base:tags */
   public static class RemoveTagsRequest extends com.arcussmarthome.client.ClientRequest {
   ...
   public static class RemoveTagsResponse extends com.arcussmarthome.client.ClientEvent {
      ...
      public RemoveTagsResponse(com.arcussmarthome.client.ClientEvent copy) {
         super(copy.getType(), copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }
   }
   
   /** Sent when a new object is added to the system. */
   public static class AddedEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public AddedEvent(com.arcussmarthome.client.ClientEvent copy) {
   ...
   public static class ValueChangeEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public ValueChangeEvent(com.arcussmarthome.client.ClientEvent copy) {
         super(NAME, copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }

   }
   
   public static class DeletedEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public DeletedEvent(com.arcussmarthome.client.ClientEvent copy) {
         super(NAME, copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }
   ...
   public static class GetAttributesValuesResponseEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public GetAttributesValuesResponseEvent(com.arcussmarthome.client.ClientEvent copy) {
         super(NAME, copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }
   ...
   public static class SetAttributesErrorEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public SetAttributesErrorEvent(com.arcussmarthome.client.ClientEvent copy) {
         super(NAME, copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
         init();
      }
   ...
   /** Sent when an observable attribute is changed. */
   public static class ReportEvent extends com.arcussmarthome.client.ClientEvent {
      ...
      public ReportEvent(com.arcussmarthome.client.ClientEvent copy) {
         super(NAME, copy.getSourceAddress(), new java.util.HashMap<String, Object>(copy.getAttributes()));
      }
