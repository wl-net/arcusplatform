 ...
 *
 */
package com.arcussmarthome.oculus.modules.session;
...
import com.arcussmarthome.messages.service.AccountService;
...
import com.arcussmarthome.client.connection.ConnectionEvent;
import com.arcussmarthome.client.connection.ConnectionState;
...
import com.arcussmarthome.client.event.ListenerList;
import com.arcussmarthome.client.event.ListenerRegistration;
import com.arcussmarthome.client.event.SettableClientFuture;
import com.arcussmarthome.client.impl.netty.NettyIrisClientFactory;
import com.arcussmarthome.client.service.AccountService.CreateAccountRequest;
import com.arcussmarthome.client.service.PersonService;
import com.arcussmarthome.client.service.PersonService.ChangePasswordResponse;
import com.arcussmarthome.client.service.SessionService;
import com.arcussmarthome.client.session.Credentials;
import com.arcussmarthome.client.session.SessionActivePlaceSetEvent;
import com.arcussmarthome.client.session.SessionInfo;
import com.arcussmarthome.client.session.SessionInfo.PlaceDescriptor;
import com.arcussmarthome.client.session.SessionPlaceClearedEvent;
import com.arcussmarthome.client.session.SessionTokenCredentials;
import com.arcussmarthome.client.session.UsernameAndPasswordCredentials;
import com.arcussmarthome.io.json.JSON;
import com.arcussmarthome.oculus.Oculus;
import com.arcussmarthome.oculus.Oculus.ProgressOptions;
import com.arcussmarthome.oculus.modules.place.dialog.SelectNewPlacePrompt;
import com.arcussmarthome.oculus.modules.session.event.PlaceChangedEvent;
import com.arcussmarthome.oculus.modules.session.event.SessionAuthenticatedEvent;
import com.arcussmarthome.oculus.modules.session.event.SessionEvent;
import com.arcussmarthome.oculus.modules.session.event.SessionExpiredEvent;
import com.arcussmarthome.oculus.modules.session.ux.ChangePasswordDialog;
import com.arcussmarthome.oculus.modules.session.ux.InvitationWizard;
import com.arcussmarthome.oculus.modules.session.ux.LoginDialog;
import com.arcussmarthome.oculus.modules.session.ux.ResetPasswordWizard;
import com.arcussmarthome.oculus.util.Actions;
import com.arcussmarthome.oculus.widget.ProgressDialog;
import com.arcussmarthome.oculus.widget.ProgressDialog.Progress;
...
public class SessionController {
   ...
   protected void onSessionEvent(com.arcussmarthome.client.session.SessionEvent event) {
      if(event instanceof com.arcussmarthome.client.session.SessionAuthenticatedEvent) {
         SessionInfo info =
               ((com.arcussmarthome.client.session.SessionAuthenticatedEvent) event).getSessionInfo();
      ...
      if (event instanceof com.arcussmarthome.client.session.SessionExpiredEvent) {
         sessionExpired();
      }
   }
   ...
   protected void sessionExpired() {
      ...
      com.arcussmarthome.oculus.Main.onLogout();
      ...
      promptLogin("Session expired")
         .onSuccess(com.arcussmarthome.oculus.Main::onAuthenticated)
         .onFailure((e) -> {
