 ...
 * 
 */
package com.arcussmarthome.oculus.widget;
...
import com.arcussmarthome.oculus.util.Attributes;
...
public class Fields {
   ...
   public static class ListFieldBuilder<V> extends FieldBuilder<JList<V>, V> {
      ...
      /**
       * @return
       * @see com.arcussmarthome.oculus.widget.ListBoxBuilder#singleSelectionMode()
       */
      ...
      /**
       * @return
       * @see com.arcussmarthome.oculus.widget.ListBoxBuilder#singleIntervalSelectionMode()
       */
      ...
      /**
       * @return
       * @see com.arcussmarthome.oculus.widget.ListBoxBuilder#multipleIntervalSelectionMode()
       */
